...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NL = 9,                         /* NL  */
  YYSYMBOL_DIGIT = 10,                     /* DIGIT  */
  YYSYMBOL_YYACCEPT = 11,                  /* $accept  */
  YYSYMBOL_str0 = 12,                      /* str0  */
  YYSYMBOL_str = 13,                       /* str  */
  YYSYMBOL_nl = 14                         /* nl  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ADD", "SUB",
  "MULTIPLY", "DIVIDE", "LBRACKET", "RBRACKET", "NL", "DIGIT", "$accept",
  "str0", "str", "nl", YY_NULLPTR
};
...
{
       0,     7,    10,    12,    13,    13,     0,     3,     4,     5,
       6,     9,    14,     8,    13,    13,    13,    13
};
